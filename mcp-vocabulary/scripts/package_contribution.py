#!/usr/bin/env python3
"""
package_contribution.py — Package a vocabulary contributor's export into a zip archive.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Package vocabulary contribution export files into a zip archive"
    )
